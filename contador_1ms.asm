...
;rotina interrupt
	...
	MOVWF 0X36 ; salvando registrador p/ evitar overflow

	BcF 0x0B,2 ;VOLTAR A TER INTERRUPT

	MOVLW 248 ;P/ CONTAR 1ms
	MOVWF 0X01
...
FF:
	MOVF 0X36,W ;voltando valor original de w
...
DIG:
	ADDWF PCL,1 ; %endereço que se localizam as instruções
	RETLW 0x3F ;0
	RETLW 0x06 ;1
	RETLW 0x5B ;2
	RETLW 0x4F ;3
